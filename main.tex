...
\author{ Venkata Raghav %<-this  stops a space
% <-this % stops a space
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=\columnwidth]{~/SignalProcessing/3/xnyn.pdf}
\end{center}
\captionof{figure}{}
\label{fig:xnyn}	
\end{figure}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{~/SignalProcessing/4/dtft}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{~/SignalProcessing/5/hn}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{~/SignalProcessing/5/hndef}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{~/SignalProcessing/5/ynconv}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{~/SignalProcessing/6/yndft}
...
\begin{lstlisting}
wget https://github.com/avraghav07/SignalProcessing/blob/master/6/xk.py
\end{lstlisting}
Use the following command in the terminal to run the code
\begin{lstlisting}
python3 xk.py
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{~/SignalProcessing/6/fft_ifft}
\caption{IFFT}
\label{fig:fft_ifft}
\end{figure}
...
Run the following code 
\begin{lstlisting}
wget https://github.com/avraghav07/SignalProcessing/blob/master/7/7.2.1.py
\end{lstlisting}
Use the following command in the terminal to run the code and generate the figure below
\begin{lstlisting}
python3 7_2_1.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{~/SignalProcessing/7/7.2.1.png}
\caption{$|H(e^{j\omega})|$}
\end{figure}
Run the following code 
\begin{lstlisting}
wget https://github.com/avraghav07/SignalProcessing/blob/master/7/7.2.2.py
\end{lstlisting}
Use the following command in the terminal to run the code and generate the figure below
\begin{lstlisting}
python3 7_2_2.py
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{~/SignalProcessing/7/7.2.2.png}
\caption{h(n)}
\end{figure}
